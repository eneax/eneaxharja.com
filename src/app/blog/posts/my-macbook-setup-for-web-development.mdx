...
date: "2024-04-14"
summary: "Setup a MacBook for web development."
---

My MacBook setup for web development includes tools like: [Homebrew](https://brew.sh), [Arc](https://arc.net), [Visual Studio Code](https://code.visualstudio.com) with [Oh My Zsh](https://ohmyz.sh), and [Git](https://git-scm.com).
...
**Arc** (browser): when I need to test something on Chromium.
