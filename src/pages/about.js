      ...
      <div>
        <Container>
          ...
          <MainTextWrapper>
            ...
            <p>
              When I’m not coding, I read <Link to='/booklist'>books</Link>, procastinate on <a href='https://waitbutwhy.com/' target='_blank' rel='noopener noreferrer'>Wait But Why</a> and <a href='http://www.ynharari.com/' target='_blank' rel='noopener noreferrer'>Y. N. Harari</a> or just walk around in nature.
            </p>
            <p>
              I'm open to new opportunities and always looking for new
              projects where I can contribute. Feel free to take a look at
                  my complete resume over <a href='https://drive.google.com/open?id=14qK2Mu5CkkZfep2Ywr_hiQPpc5uc0uLx' target='_blank' rel='noopener noreferrer'>here</a>.
            </p>
          </MainTextWrapper>
        </Container>
