...
To add tags to your Gatsby MDX blog posts, you need to have your site set up to convert MDX files into blog posts (I wrote about it <a href='https://eneaxharja.com/convert-an-existing-gatsby-blog-to-use-mdx' target='_blank' rel='noreferrer'>here</a>).
