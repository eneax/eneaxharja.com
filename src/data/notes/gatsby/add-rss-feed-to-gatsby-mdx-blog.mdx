...
An <a href='https://en.wikipedia.org/wiki/RSS' target='_blank' rel='noreferrer'>RSS Feed</a> is a standard XML file with the purpose of listing the content of a website in a subscribable format.
...
To generate an RSS Feed for your Gatsby MDX blog, you need the <a href='https://en.wikipedia.org/wiki/RSS' target='_blank' rel='noreferrer'>gatsby-plugin-feed-mdx</a> package.
...
For reference, <a href="https://github.com/eneax/eneaxharja.com/blob/master/gatsby-config.js" target="_blank" rel="noreferrer">here</a> is my entire `gatsby-config.js` file.
