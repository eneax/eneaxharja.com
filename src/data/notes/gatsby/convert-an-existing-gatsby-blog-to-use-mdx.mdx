...
For reference, <a href='https://github.com/eneax/eneaxharja.com/blob/master/gatsby-config.js' target="_blank" rel="noreferrer">here</a> is my entire gatsby-config file.
...
My `gatsby-node.js` file is available over <a href="https://github.com/eneax/eneaxharja.com/blob/master/gatsby-node.js" target="_blank" rel="noreferrer">here</a>.
...
For reference, <a href='https://github.com/eneax/eneaxharja.com/blob/master/src/templates/postTemplate.js' target="_blank" rel="noreferrer">here</a> is my entire `postTemplate` component.
