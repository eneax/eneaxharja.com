...
If you need some inspiration, have a look at my <a href='https://github.com/eneax/dotfiles' target='_blank'>dotfiles</a> and check my <a href='https://github.com/eneax/eslint-config-eneax' target='_blank'>eslint-config-eneax</a> package.
