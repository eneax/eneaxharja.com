...
Inside your `gatsby-node.js` file, update the queries that fetch your MDX posts and the one for your tags (if you have this feature implemented on your website, if not check out <a href='https://eneaxharja.com/add-tags-and-categories-to-gatsby-mdx-blog' target="_blank" rel="noreferrer">my post</a> for more info):
...
In case you need some help with adding an RSS Feed to your Gatsby MDX blog, I wrote about it <a href='https://eneaxharja.com/add-rss-feed-to-gatsby-mdx-blog' target="_blank" rel="noreferrer">here</a>.
