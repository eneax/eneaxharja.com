...
If you need to add an external script (or 3rd party script) in your Gatsby website, without using any plugin, the best approach would be to use <a href='https://www.gatsbyjs.com/docs/ssr-apis' target='_blank' rel='noopener'>Gatsby SSR API</a>.
...
If you want to learn more about Gatsby and its ecosystem, head over to the <a href='https://www.gatsbyjs.com/docs' target='_blank' rel='noopener'>official website</a>.
