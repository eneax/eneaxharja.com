...
For more information, you can have a look at <a href='https://tailwindcss.com' target='_blank'>Tailwind</a> and <a href='https://styled-components.com' target='_blank'>styled-components</a> offical documentation.
