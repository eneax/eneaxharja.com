...
For reference, <a href="https://github.com/eneax/eneaxharja.com/blob/master/gatsby-config.js" target="_blank" rel="noopener">here</a> is my entire `gatsby-config.js` file.
