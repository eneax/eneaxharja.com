...
date: '2020-08-04'
published: true
title: '🛠️ Convert an existing Gatsby Markdown blog to use MDX'
tags: ['gatsby']
---
...
For reference, <a href='https://github.com/eneax/eneax.github.io/blob/master/gatsby-config.js' target="_blank" rel="noopener">here</a> is my entire gatsby-config file.
...
My `gatsby-node.js` file is available over <a href="https://github.com/eneax/eneax.github.io/blob/master/gatsby-node.js" target="_blank" rel="noopener">here</a>.
...
For reference, <a href='https://github.com/eneax/eneax.github.io/blob/master/src/templates/postTemplate.js' target="_blank" rel="noopener">here</a> is my entire `postTemplate` component.
