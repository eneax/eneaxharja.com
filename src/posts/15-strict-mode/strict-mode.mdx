...
A great example is using it for variables.

Previously, an attempt to assign `dog = 'Rex'`, where dog hasn’t been defined, would have assigned the value to the dog property of the global object (e.g. window.dog).
