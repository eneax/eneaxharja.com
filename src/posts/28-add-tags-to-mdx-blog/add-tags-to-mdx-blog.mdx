...
To add tags to your Gatsby MDX blog posts, you need to have your site set up to convert MDX files into blog posts (I wrote about it <a href='https://eneaxharja.com/blog/convert-an-existing-gatsby-blog-to-use-mdx' target='_blank' rel='noopener'>here</a>).
...
For reference, <a href='https://github.com/eneax/eneax.github.io/blob/master/gatsby-node.js' target='_blank' rel='noopener'>here</a> is my entire `gatsby-node.js` file.
...
You can have a look at how tags work in Gatsby directly from my personal website repo on <a href="https://github.com/eneax/eneax.github.io" target="_blank" rel="noopener">GitHub</a>.
