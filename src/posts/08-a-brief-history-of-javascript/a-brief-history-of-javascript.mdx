...
Flash forward 25 years and JavaScript is the world's most popular programming language (according to <a href='https://octoverse.github.com' target='_blank'>Github</a> and <a href='https://insights.stackoverflow.com/survey/2019' target='_blank'>Stack Overflow</a>).

Today, JavaScript is one of the core technologies of the web, along with HTML and CSS and it's being used in fields that go beyond the web, like machine learning, virtual reality and even in robotics and IoT platforms like <a href='http://johnny-five.io' target='_blank'>Johnny-Five</a>.
