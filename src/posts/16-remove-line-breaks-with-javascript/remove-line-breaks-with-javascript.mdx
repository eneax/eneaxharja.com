---
slug: '/remove-line-breaks-with-javascript'
date: '2020-03-23'
published: true
title: '🔥 Remove Line Breaks with Javascript'
tags: ['hot-tip', 'javascript']
---
...
Let's first define the string variable with some <a href='https://hipsum.co' target='_blank'>Hipster Ipsum</a> text that we need to format:
