---
slug: '/tailwind-with-styled-components'
date: '2020-10-23'
published: true
...
For more information, you can have a look at <a href='https://tailwindcss.com' target='_blank' rel='noopener'>Tailwind</a> and <a href='https://styled-components.com' target='_blank' rel='noopener'>styled-components</a> offical documentation.
